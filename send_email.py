...
<div class="wrapper">
  <div class="header">
    <div class="hi">
      <div><h1>The New Yorker Daily</h1><div class="sub">US Deep Report AI Summary</div></div>
      <div class="db"><span>Date</span>{{DATE}}</div>
    </div>
  </div>
  <div class="mb">Today {{COUNT}} articles</div>
  <div class="arts">{{ARTICLES}}</div>
  <div class="ft"><p>Auto-generated by OpenClaw Agent</p><p>Source: The New Yorker (feedx.net)</p></div>
</div>
</body>
</html>"""
...
def send_email(path):
    ...
    msg["From"] = EMAIL_FROM
    msg["To"] = EMAIL_TO
    msg["Subject"] = "The New Yorker Daily · " + df
